  ...
  <Layout title="Nosotros">
    ...
    <div className="info">
      ...
      <p class="sm:col-spab=n-3">
        ...
        encuentran con dudas de ejercicios o temas no puedan aclararlas, lo que
        afecta su rendimiento académico y genera frustración en ellos. Una
        solución sería una página web que tenga las siguientes características:
        tener un ambiente de consulta para las materias, compartir respuestas o
        realizar nuevas preguntas de un ejercicio y generar discusión entre
        estudiantes sobre cómo resolver un ejercicio.
      </p>
      <p></p>
