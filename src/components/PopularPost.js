            ...
            <div className="rounded-lg mt-8 md:ml-24 border-solid border-2 border-gray-101 text-base h-auto ml-12 mb-8 w-3/4">
                <div className=" mx-2 md:mx-4">
                    ...
                    <div className="flex justify-center md:float-right">
                        <img class=" rounded-lg h-24 mx-2 md:ml-4 my-5" src="https://images.unsplash.com/photo-1459262838948-3e2de6c1ec80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80https://imgur.com/a/0Jlvibw" alt="popularPostImg"/>
                    </div>
                    ...
                    <button className="py-1 px-6 m-4  bg-blue-106 shadow text-white rounded-lg focus:outline-none focus:bg-blue-103 hover:bg-blue-103" >Ir</button>
                </div>
