            ...
            <div className="rounded-lg mt-8 md:ml-24 border-solid border-2 border-gray-101 text-base h-auto ml-12 mb-8 w-3/4">
                <div className="my-2 md:flex">
                    ...
                    <div class="m-4 md:mr-8 mt-4 content-center md:flex-shrink-0">
                        <img class="rounded-lg md:w-56"  src="https://images.unsplash.com/photo-1459262838948-3e2de6c1ec80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80https://imgur.com/a/0Jlvibw" alt="popularPostImg"/>
                    </div>
